...
export function ChatPanel({
  ...
  return (
    <div
      className={cn(
        'w-full bg-background group/form-container shrink-0 relative',
        messages.length > 0 ? 'sticky bottom-0 px-2 pb-4' : 'px-6'
      )}
    >
      <div className="chat-gradient-bg fixed bottom-0 left-0 right-0 h-[335px] pointer-events-none -z-10" />
